...
# global settings
_C.workspace           = "/skin_data/commodity/models/0512/shufflenetv2_x1_0_96" # directory to save weights file
...
# dataset parameters
_C.dataset                   = CN()
_C.dataset.train_path        = "/skin_data/commodity/train.txt"
_C.dataset.test_path         = "/skin_data/commodity/test.txt"
...
# train parameters 
_C.train = CN()
_C.train.classes     = 17               # num of classes
