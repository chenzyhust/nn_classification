...
class MNASNet(torch.nn.Module):
    ...
    def __init__(self, alpha, num_classes=1000, multitask=1, dropout=0.2):
        ...
        # self.classifier = [nn.Linear(1280, i) for i in self.num_classes]
        for i in range(len(self.num_classes)):
            setattr(self, 'classifier{}'.format(i), nn.Linear(1280, self.num_classes[i]))
...
def mnasnet0_5(num_classes=1000, multitask=1, **kwargs):
    """MNASNet with depth multiplier of 0.5 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    Args:
    """
    model = MNASNet(0.5, num_classes, multitask=multitask, **kwargs)
    return model


def mnasnet0_75(num_classes=1000, multitask=1, **kwargs):
    """MNASNet with depth multiplier of 0.75 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    Args:
    """
    model = MNASNet(0.75, num_classes, multitask=multitask, **kwargs)
    return model


def mnasnet1_0(num_classes=1000, multitask=1, **kwargs):
    """MNASNet with depth multiplier of 1.0 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    Args:
    """
    model = MNASNet(1.0, num_classes, multitask=multitask, **kwargs)
    return model


def mnasnet1_3(num_classes=1000, multitask=1, **kwargs):
    """MNASNet with depth multiplier of 1.3 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    Args:
    """
    model = MNASNet(1.3, num_classes, multitask=multitask, **kwargs)
    return model


if __name__ == '__main__':
    model = mnasnet0_5((10, 20), multitask=2)
