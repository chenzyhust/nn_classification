...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        # if isinstance(self._global_params.num_classes, int):
        #     self._global_params.num_classes = tuple([self._global_params.num_classes])
        ...
        # self.classifier = [nn.Linear(out_channels, i) for i in self.num_classes]
        # for i in range(len(self.num_classes)):
        #     setattr(self, 'classifier{}'.format(i), nn.Linear(out_channels, self.num_classes[i]))
    ...
    def forward(self, inputs):
        ...
        # for i in range(len(self.num_classes)):
        #     features.append(x)
        #     output.append(eval('self.classifier{}'.format(i))(x))
        return output, features

    @classmethod
    def from_name(cls, model_name, num_classes=1000, override_params=None):
...
if __name__ == '__main__':
    ...
    model = efficientnet_b2((10, 20), multitask=2)
